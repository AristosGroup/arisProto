...
var Issue = DS.Model.extend({
  ...
  //  boundTagsBinding: Ember.Binding.multiple('tags'),
    tags: DS.hasMany('tag', { async: true,embedded:true }),
...
Issue.FIXTURES = [
    { id: 1, type: 1, subject: 'Related Products', description: 'Glowacki', projects: [1], status: 1, assigned_to: 1, followers: [1, 2], tags: [1,2] },
    { id: 2, type: 1, subject: 'Mass Compare', description: 'Dale', projects: [1, 2], status: 2, assigned_to: 2, followers: [2], tags: [2,3]   }
];
